          ...
          child: Padding(
            ...
            child: TableCalendar(
              ...
              daysOfWeekStyle: DaysOfWeekStyle(
                weekdayStyle: kTaglineTextStyle(context).copyWith(
                  color: kBrown,
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ),
                weekendStyle: kTaglineTextStyle(context).copyWith(
                  color: kPink,
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ),
              ...
              selectedDayPredicate: (date) =>
                  holidayDates.any((d) => _isSameDay(d, date)),
              eventLoader: (date) =>
                  holidayDates.any((d) => _isSameDay(d, date)) ? [date] : [],
