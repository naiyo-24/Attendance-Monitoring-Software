                          ...
                          children: [
                            ...
                            TextField(
                              decoration: InputDecoration(
                                ...
                                hintStyle: kCaptionTextStyle(context).copyWith(
                            ...
                            Align(
                              ...
                              child: Text(
                                ...
                                style: kCaptionTextStyle(context).copyWith(
                                  color: kBrown.withAlpha((0.7 * 255).toInt()),
                                ),
                              ),
                            ),
                          ],
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) => EmployeeCard(
                            employee: {
                              ...
                              'designation':
                                  filteredEmployees[index].designation,
                              'address': filteredEmployees[index].address,
                              'profilePhoto':
                                  filteredEmployees[index].profilePhoto,
                            },
